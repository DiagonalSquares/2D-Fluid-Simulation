...
- [project_overview.md](project_overview.md) — 2D SPH fluid simulation: tech stack, key concepts, constants, active branches
- [project_structure.md](project_structure.md) — File layout, module responsibilities, dependency graph
